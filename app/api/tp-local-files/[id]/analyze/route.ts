...
import { normalizeTpProjectState, tpProjectCompleteness } from "@/lib/tp-local-file";
...
Rules: distinguish document facts from advisor inference; never invent amounts, counterparties, ratios, or regulations; explain why the selected method, PLI, and tested party are or are not supportable; state material gaps; cite only regulations in the supplied regulation context. Use ${language === "en" ? "English" : "Bahasa Indonesia"}.
